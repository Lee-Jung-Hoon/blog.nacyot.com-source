...
얼마 전 '[[도커 코리아|docker-korea]]'라는 이름으로 [스터디를 진행한다는 이야기][first]를 전한 바 있습니다. 그 후로 시간이 흘러 지난 8월 2일에 [도커 코리아 두번째 모임][second]을 가졌습니다. 이번 스터디는 시범적인 차원에서 공개적으로 진행되었습니다. 단 아직 정기적인 스터디 지원이 확정되지 않아, 이번 모임은 소정의 참가비와 부족한 부분은 [[리모티|remotty]] 재정의 지원으로 이루어졌습니다. 리모티 팀원들을 비롯해 총 16분이 참석해 자리를 빛내주셨습니다 :)
